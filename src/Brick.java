...
public class Brick extends Structure implements Constants {
    ...
    private Color[] orangeColors = {ORANGE_BRICK_ONE, ORANGE_BRICK_TWO, ORANGE_BRICK_THREE, Color.BLACK};
    private Color[] greenColors = {GREEN_BRICK_ONE, GREEN_BRICK_TWO, GREEN_BRICK_THREE, Color.BLACK};
    private Color[][] colors = {blueColors, redColors, purpleColors, yellowColors, pinkColors, orangeColors, greenColors};
